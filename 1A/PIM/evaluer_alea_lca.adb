...
procedure Evaluer_Alea_LCA is
    ...
    is
        ...
        procedure Remplir(Sda : in out T_LCA) is
            nbAlea : Integer;
            nbTemp : Integer;
        begin
        ...
        procedure Calculer_min_et_max(Sda : T_LCA ; min : out Integer ; max : out Integer) is
            Donnee_Temp : Integer;
        begin
            min := La_Donnee(Sda, 1);
            max := La_Donnee(Sda, 1);
        ...
        procedure Calculer_occurence_min_et_max(Sda : in out T_LCA ; occMin : in out Integer ; occMax : in out Integer) is
