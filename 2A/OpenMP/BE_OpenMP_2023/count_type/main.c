...
//parallel version of work where the main loop is parallelized and the conflict is resolved using critical sections
void work_par_critical(data_t *data, unsigned int *typecounts, int ndata, int ntype){
  int i;
...
//parallel version of work where the main loop is parallelized and the conflict is resolved using locks
void work_par_locks(data_t *data, unsigned int *typecounts, int ndata, int ntype){
  int i;
  omp_lock_t *locks;
...
//parallel version of work where the main loop is parallelized and the conflict is resolved using atomic instructions
void work_par_atomic(data_t *data, unsigned int *typecounts, int ndata, int ntype){
  int i;
