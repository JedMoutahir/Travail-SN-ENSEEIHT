...
public class AfficheurInfixeMinimal extends AfficheurInfixe {
	...
	public AfficheurInfixeMinimal(int pGauche, int pDroite) {
		this.pGauche = pGauche;
		this.pDroite = pDroite;
	}
	
	public AfficheurInfixeMinimal() {
	}
	...
	@Override
	public String visiterLet(Let let) {
		// TODO Auto-generated method stub
		return "let " + let.getName() + " = " + let.getLeftValue() + " in " + let.getRightValue();
	}
